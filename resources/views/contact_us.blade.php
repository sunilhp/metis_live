    ...
    <section class="terms_page">
        <div class="container">
            ...
            <div class="contact_page_de">
                <ul>
                    <li><img src="{{ url('/resources/assets/img/E555D4F3-E845-4D9D-8234-55E259236571@1x.png')}}">West Hills, California, USA</li>
                    <li><img src="{{ url('/resources/assets/img/3F97BE5B-CBE3-47F2-BAD3-A870C97F68EF@1x.png')}}"><a href="#">(202) 280-2038</a></li>
