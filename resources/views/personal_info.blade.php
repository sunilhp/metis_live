                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 top_part">
                            ...
                            <form method="post" action="{{url('personal-information/edit')}}"
                                  enctype="multipart/form-data" class="dropzone" id="edit-profile">
                                {{ csrf_field() }}
                            </form>
                        </div>
                        <div class="col-md-12 top_part2">
                            <form method="POST" action="{{url('save-personal-information')}}">
                                {{ csrf_field() }}
                                <h3>{{$record->fname}} {{$record->lname}}<span>{{$record->email}}</span> <a
                                            id="save-personal" href="#" class="editLogo"></a></h3>
                                ...
                                <div class="form-group form-group1{{ $errors->has('opassword') ? ' has-error' : '' }}">
                                    <input type="password" name="opassword" id="opassword" class="inn1"
                                           value="{{ old('opassword') }}" placeholder="Current Password">
                    ...
                    <strong>{{ $errors->first('opassword') }}</strong>
                                ...
                                <div class="form-group form-group1{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <input type="password" name="password" id="password" class="inn1"
                    ...
                    <strong>{{ $errors->first('password') }}</strong>
                                ...
                                <div class="form-group form-group1{{ $errors->has('cpassword') ? ' has-error' : '' }}">
                                    ...
                                    <input type="password" name="cpassword" id="cpassword" class="inn1"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 top_part top_parta">
                            <div class="clearfix"></div>
                            <figure><img
                                        src="@if($records[0]->profile_pic!=""){{ url('/public/'.$records[0]->profile_pic)}} @else {{ url('/resources/assets/img/p_info_img.png')}} @endif">
                            </figure>
                        </div>
                        <div class="col-md-12 top_part2">
                            <h3>{{$record->fname}} {{$record->lname}}<span>{{$record->email}}</span> <a
                                        href="{{ url('/personal-information/edit')}}" class="editLogo"></a></h3>

                            <div class="clearfix"></div>
                            <div class="icon1"><img src="{{asset('resources/assets/img/icon/address_b.png')}}"></div>
                            <div class="form-group form-group1">
                            ...
                            <div class="clearfix"></div>
                            <div class="icon1"><img src="{{asset('resources/assets/img/icon/home_phone_b.png')}}"></div>
                            <div class="form-group form-group1">
                                <p>{{$record->pnumber}}</p>
                            </div>

                            <div class="clearfix"></div>
                            <div class="icon1"><img src="{{asset('resources/assets/img/icon/cell_phone_b.png')}}"></div>
                            <div class="form-group form-group1">
                                <p>{{$record->onumber}}</p>
                            </div>
